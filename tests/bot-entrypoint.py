...
"""
This file is the main process running inside of the ca-bot container for the
integration tests. This allows the kssh container to specify that the tests
should run with a specific set of environment variables. This allows us to
easily run integration tests for different keybaseca config options.
"""
...
def load_env():
    ...
    os.system(
        (
            ...
            "ssh-keygen -t ed25519 -f /shared/userkey -N '' && "
            "bin/keybaseca sign --public-key /shared/userkey.pub > "
            "/shared/keybaseca-sign.out\n"
