...
def write_env_files(kssh_user, ca_user, parent_team):
    with open("tests/single-environment/env.sh", "w+") as f:
        f.write("#!/bin/bash\n"
                ...
                f"export SUBTEAM='{parent_team}.single_env_ssh'\n"
                f"export SUBTEAM_SECONDARY='{parent_team}.secondary'\n")
    with open("tests/multi-environment/env.sh", "w+") as f:
        f.write("#!/bin/bash\n"
                "# File automatically generated by configure_accounts.py"
                f"export BOT_USERNAME='{ca_user.username}'\n"
                f"export BOT_PAPERKEY='{ca_user.paperkey}'\n"
...
if __name__ == '__main__':
    ...
    ca_user.create_team_and_invite(parent_team + ".single_env_ssh", kssh_user.username)
