...
def write_env_files(kssh_user, ca_user, two_man_approver, parent_team):
...
if __name__ == '__main__':
    ...
    ca_user.create_team_and_invite(parent_team + ".ssh", kssh_user.username, two_man_approver.username)
    ca_user.create_channel(parent_team + ".ssh", "ssh-provision")
    kssh_user.join_channel(parent_team + ".ssh", "ssh-provision")
    two_man_approver.join_channel(parent_team + ".ssh", "ssh-provision")
    ca_user.create_team_and_invite(parent_team + ".ssh.staging", kssh_user.username, two_man_approver.username)
    ca_user.create_team_and_invite(parent_team + ".ssh.prod", two_man_approver.username)
    ca_user.create_team_and_invite(parent_team + ".ssh.root_everywhere", kssh_user.username, two_man_approver.username)

    ca_user.create_team_and_invite(parent_team + ".secondary", kssh_user.username, two_man_approver.username)

    write_env_files(kssh_user, ca_user, two_man_approver, parent_team)
